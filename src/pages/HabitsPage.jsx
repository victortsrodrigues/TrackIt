    ...
    <>
      <BodyHabits>
        ...
        <ConteinerHabits>
              ...
              <CreatedHabit key={elemento.id}>
                ...
                <Days>
                  {days.map((elementoDay, indexDay) => {
                    return (
                      <DayOption key={indexDay} $isSelected={elemento.days.includes(indexDay)}>{elementoDay}</DayOption>
                    )
                  })}
                </Days>
              </CreatedHabit>
          ...
          {noHabits &&
            <Disclaimer>Você não tem nenhum hábito cadastrado ainda. Adicione um hábito para começar a trackear!</Disclaimer>
          }
        </ConteinerHabits>
